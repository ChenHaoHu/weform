...
import com.hcy.message.model.FormDO;
...
public interface FormMapper {
    ...
    @Select("SELECT title FROM form WHERE formid = #{formid} LIMIT 1;")
     String getTitleByFormid(@Param("formid") Integer formid);
    ...
    @Select("SELECT title,start FROM form WHERE formid = #{formid} LIMIT 1;")
    Map<String,String> getFormTitleAndStartTime(@Param("formid") Integer formid);
